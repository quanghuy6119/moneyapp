            ...
            await $.ajax({
                ...
                success: function (response) {
                    ...
                    if (result.length != 0) {
                        ...
                        $('.row-wallet').append(`<script src="${window.location.origin}/js/walletIcon.js" class="wallet-icon-script"></script>`);
                    }
                },
                error: function (e) {
                    console.log(e);
        ...
        const getWallet = async () => {
            await $.ajax({
                ...
                success: function (response) {
                    ...
                    $('.row-wallet-parent').append(`<script src="${window.location.origin}/js/walletList.js" class="wallet-parent-script"></script>`);
                },
                error: function (e) {
                    console.log(e);
                }
