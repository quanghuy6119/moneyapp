<div class="box-modal-wallet unactive">
    ...
    <form method="POST" class="form-wallet">
        ...
        <div class="row row-add-wallet">
            <div class="col-3 mb-3 ">
                ...
                <input type="hidden" class="wallet-icon-input" name="transaction_id" value="1">
            </div>
            ...
            <div class="col-6 mb-3">
                ...
                <input type="text" id="wallet-budget-input" class="wallet-form-input wallet-budget money"
                    name="budget-init" placeholder="Your Init Budget" required>
                <input type="hidden" class="wallet-budget-real" name="budget-real" value="0">
            </div>
    ...
    <div class="box-modal-wallet-icon unactive">
        <div class="wallet-header">
    ...
    <div class="box-modal-wallet-parent unactive">
        <div class="wallet-header">
